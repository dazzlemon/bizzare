...
func can_see_player() -> bool:
	if player == null:
		...
		return not is_look_at_intersecting and has_player_inside_fov()
...
func has_player_inside_fov() -> bool:#player is inside this enemy instance fov
	...
	var angle_look_at_to_player = look_at.cast_to.angle_to(vec_self_to_player)
